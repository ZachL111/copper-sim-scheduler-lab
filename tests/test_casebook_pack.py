"""Regression checks for the copper-sim-scheduler-lab casebook."""
...
from casebook.harness import assert_expected, copper_sim_scheduler_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_sim_scheduler_lab_summary(), assert_expected())
