...
`copper-sim-scheduler-lab` is centered on simulations work in C#. The technical target is: Create a C# reference implementation for scheduler workflows, centered on simulation kernel, seeded input scenarios, and deterministic summary checks.
...
The score is deterministic. The current threshold is 152. Risk has a penalty of 4, latency has a penalty of 3, and weight contributes a bonus of 4.
